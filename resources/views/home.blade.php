                ...
                @foreach ($articles as $art)
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <span class="label label-info"><a href="{{ url('category/'.$art->category_id) }}">{{$art->category->title}}</a></span>
                            ...
                            <em>資源： <a href="{{ $art->source_link }}" class="label label-danger" target="_blank">{{ $art->website->title}}</a></em>
